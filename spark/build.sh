...
download_jar_file   "hadoop-aws-3.3.5.jar" "https://repo1.maven.org/maven2/org/apache/hadoop/hadoop-aws/3.3.5/hadoop-aws-3.3.5.jar"
...
AWSSDK_VERSION=2.20.18
download_jar_file   "bundle-${AWSSDK_VERSION}.jar" "https://repo1.maven.org/maven2/software/amazon/awssdk/bundle/${AWSSDK_VERSION}/bundle-${AWSSDK_VERSION}.jar" 
download_jar_file   "url-connection-client-${AWSSDK_VERSION}.jar" "https://repo1.maven.org/maven2/software/amazon/awssdk/url-connection-client/${AWSSDK_VERSION}/url-connection-client-${AWSSDK_VERSION}.jar" 
...
REPOSITORY="bbccorp"
IMAGE_NAME="spark"
TAG="bitnami-spark_3.3.2-postgresql_42.6.0"
